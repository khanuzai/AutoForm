    ...
    <div className="glass-card rounded-3xl p-8 hover-card">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-gray-600 text-sm">
              AI-generated content ready to use
            </p>
          </div>
        </div>
        ...
        {filledForm && (
          <button
            onClick={handleCopy}
            className="modern-button bg-gradient-to-r from-purple-600 to-pink-600 text-white py-2 px-4 text-sm font-medium inverted-hover"
          >
            📋 Copy
          </button>
        )}
      ...
      <div className="relative">
        {isLoading ? (
          <div className="space-y-4">
            ...
            <div className="h-4 bg-gray-200 rounded shimmer" style={{ width: '85%' }}></div>
            ...
            <div className="h-4 bg-gray-200 rounded shimmer" style={{ width: '65%' }}></div>
          </div>
        ) : filledForm ? (
          <div className="space-y-4">
              ...
              <div className="flex items-center space-x-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-600">
                    AI has filled all placeholders with your profile data
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Copy the filled form and paste it wherever you need. All placeholders have been intelligently replaced with your profile information.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="text-center py-12">
            ...
            <p className="text-gray-400 text-sm">
              Fill in your profile and paste a form to generate the filled version
            </p>
          </div>
        )}
      </div>
